          ...
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="md:w-1/2 mb-10 md:mb-0">
              ...
              <p className="text-xl mb-8">
                Join our platform to reduce food waste and help those in need. Make a difference in your community today.
              </p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">Donate food or find available donations in your area</p>
            </div>
            <div className="text-center p-6">
              <div className="bg-primary bg-opacity-10 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg className="w-8 h-8 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-gray-600">Connect with others and make a difference in your community</p>
            </div>
          </div>
        </div>
      </section>
